...
export default function NoteForm({ onSubmit, editingNote, onCancelEdit, saving }) {
  ...
  return (
    <form
      ...
      className="bg-white rounded-xl border border-ink/10 p-5 space-y-4"
    >
      ...
      <div className="flex gap-3">
        <button
          type="submit"
          disabled={saving}
          className="bg-ink text-white font-semibold px-5 py-2.5 rounded-lg hover:bg-amber hover:text-ink transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
        >
